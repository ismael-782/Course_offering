...
public class CourseNotRemoved {
    ...
    popupwindow.setTitle("Course couldnt be removed");
      
      
    Label label1= new Label("Course couldnt be removed please check the selected section");
